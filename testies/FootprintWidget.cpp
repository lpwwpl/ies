...
void FootprintWidget::setupInteractions()
{
    ...
    connect(m_panner, &MyPlotPanner::panFinished, this, &FootprintWidget::updateAxesSettings);
    connect(m_magnifier, &MyPlotMagnifier::zoomed, this, &FootprintWidget::updateAxesSettings);
}
void FootprintWidget::updateAxesSettings()
{
